...
Selected figures from the docs and results directories:

| M1 detection boundary | M2 force-form restoration | Kepler-9 mass degeneracy |
|---|---|---|
| ![M1 threshold](docs/figures/m1_threshold_boundary.png) | ![M2 restoration](results/identifiability/restoration.png) | ![Kepler-9](docs/figures/kepler9_degeneracy.png) |

*(Figures are generated by the scripts above. Add your own to `docs/figures/` and `results/` after running.)*
